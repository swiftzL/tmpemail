...
type Storage struct {
	...
	MysqlHost       string            `required:"true" default:"" desc:"Mysql host"`
	MysqlUsername   string            `required:"true" default:"" desc:"Mysql username"`
	MysqlPass       string            `required:"true" default:"" desc:"Mysql password"`
}
